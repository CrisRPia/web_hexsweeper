...
>
	...
	<h3 class="h2 mb-1 mx-auto">Controles</h3>
	...
	El objetivo del juego es descubrir toda la niebla mientras se marcan con bandera todas las minas.
	<h2 class="h2 flex justify-between items-center">
		<span>Niebla</span>
		<div class="inline">
			<Board board={new LogicBoard(1, Math.floor(Math.random() + 0.5))} moveable={false} />
		</div>
	</h2>
	La niebla son las celdas sin descubrir; pueden contener minas o celdas con valor. Clickar en ellas
	revela su contenido, las "descubre".
	<h2 class="h2 flex justify-between items-center">
		<span>Minas</span>
		<div class="inline">
	...
	<div class="flex justify-evenly items-center">
		...
		<p class="m-2">
			Son las celdas sin minas que han sido descubiertas; muestran las cantidad de celdas vecinas.
			De no tener celdas vecinas, no muestran valor alguno. Al poner el cursor arriba, se resaltan
			las celdas vecinas.
		</p>
	</div>
	<h2 class="h2 flex justify-between items-center">
...
<div class="card p-4 variant-outline-warning" data-popup="popupClick">

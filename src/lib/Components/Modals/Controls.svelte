...
>
    ...
    <div class="flex justify-evenly items-center">
        ...
        <p class="m-2">
            Son las celdas sin minas que han sido descubiertas; muestran las
            cantidad de celdas vecinas. De no tener celdas vecinas, no muestran
            valor alguno. Al poner el cursor arriba, se resaltan las celdas
            vecinas.
        </p>
    </div>
    <h2 class="h2 flex justify-between items-center">
